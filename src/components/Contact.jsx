        ...
        >
          ...
          <div className="contact-info-panel">
            ...
            <div className="cip-socials">
              <a href="https://linkedin.com/in/yadurajsy" target="_blank" rel="noreferrer" className="cip-social" id="cip-linkedin" aria-label="LinkedIn">
              ...
              <a href="https://github.com/yadurajsy" target="_blank" rel="noreferrer" className="cip-social" id="cip-github" aria-label="GitHub">
                <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18" aria-hidden="true">
